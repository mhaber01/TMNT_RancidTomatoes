...
<html lang = "en">
	<head>
		...
		<meta name = "revised" content = "March 10, 2017" />
		<meta name = "generator" content = "TextWrangler" />
		<meta name = "description" content = "Teenage Mutant Ninja Turtles (TMNT) - Review" />
	</head>
	...
	<body>
		...
		<img id = "rottenbig" src = "rottenbig.png" alt = "Rotten"><span id = "rating">33%</span>
		<img id = "picture" src="overview.png" alt="general overview">
		</div>
		...
		<p class = "reviewer">
			<img src="critic.gif" alt="Critic">
			Stephen Garrett <br>
			<span class = "publication">Time Out</span>
		</p>
		</div>
		...
		<p class = "review">
			<img class = "freshOrRotten" src="rotten.gif" alt="Rotten">
			<q>It takes more than an awkward title attempting to sound cool to overcome its mundane plot and silly dialogue.</q>
		</p>
		<p class = "reviewer">
			<img src="critic.gif" alt="Critic">
			Claudia Puig <br>
